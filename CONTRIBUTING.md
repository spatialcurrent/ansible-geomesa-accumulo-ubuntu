# Contributing to ansible-geomesa-accumulo-ubuntu
...
See [AUTHORS](https://github.com/spatialcurrent/ansible-geomesa-accumulo-ubuntu/blob/master/AUTHORS) for a list of contributors.
